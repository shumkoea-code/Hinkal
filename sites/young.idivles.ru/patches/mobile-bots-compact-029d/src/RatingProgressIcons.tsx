...
const META: Record<
  RatingKind,
  { Icon: typeof Rocket; short: string; chipLabel: string; defaultColor: string }
> = {
  LEVEL: { Icon: Rocket, short: 'Ур', chipLabel: 'Уровень', defaultColor: '#0ea5e9' },
  AUTHORITY: { Icon: Gauge, short: 'А', chipLabel: 'Авторитет', defaultColor: '#2563eb' },
  SOCIAL: { Icon: Sparkles, short: 'С', chipLabel: 'Социум', defaultColor: '#7c3aed' },
  ECO: { Icon: Leaf, short: 'Э', chipLabel: 'Эко', defaultColor: '#059669' },
};
...
/** Компактные чипы — профиль / меню. Подпись + значение полностью видны. */
