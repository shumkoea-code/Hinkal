...
- 2026-08-09: навбар — анти-наложение иконок/бейджа (задеплоено в `messages-nav-fix`)
- 2026-08-09: сообщения — фильтр членства, long-press, overflow + навбар (`messages-ux-overflow.md`, tag `messages-nav-fix`)
